...
def get_online_info():
    ...
    p = subprocess.Popen("grep '%s %s' /var/log/auth.log|grep 'Accepted publickey'|egrep -v '10.21.0.128|117.29.165.58|47.75.118.35'|awk '{print $3,$9,$11}' " % (date_day,date_time), shell=True, stdout=subprocess.PIPE)
